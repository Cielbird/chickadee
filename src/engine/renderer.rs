...
impl<'a> Renderer<'a> {
    pub fn new (window: Arc<Window>) -> Self {
        ...
        let post_proc_bind_group = Self::create_post_proc_bind_group(&device, &post_proc_bind_group_layout, &post_proc_in_texture);
        let post_proc_pipeline = Self::create_post_processing_pipepine(&device, &config, &post_proc_bind_group_layout);
    ...
    fn create_post_processing_pipepine(device: &wgpu::Device, config: &wgpu::SurfaceConfiguration, 
            post_proc_bind_group_layout: &wgpu::BindGroupLayout) -> wgpu::RenderPipeline{
        ...
        device.create_render_pipeline(
            &wgpu::RenderPipelineDescriptor{
                ...
                depth_stencil: None, multiview: None, cache: None,
            }
        )
    }

    fn create_post_proc_bind_group(device: &wgpu::Device, layout: &wgpu::BindGroupLayout, 
